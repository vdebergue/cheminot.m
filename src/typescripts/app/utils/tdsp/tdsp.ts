...
export function lookForBestTrip(Storage: any, graph: any, vsId: string, veId: string, vsTripId: string, ts: number, exceptions: any, debug: (msg: string) => void): Q.Promise<any> {
