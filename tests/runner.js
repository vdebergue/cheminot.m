...
require(['require'], function(require) {
  require(['utils/tdsp/timeRefinement', 'utils/tdsp/pathSelection', 'db/storage'], function(tr, ps, Storage) {
    Storage.installDB(function() {}).then(function(){
      $.getJSON('http://localhost:9000/api/db/MjAxNC0wMS0xNF8wMC0xOS0wMA==', function(db) {
        ...
        var x = tr.timeRefinement(db.tdspGraph, vsId, veId, ts, db.exceptions);
      });
